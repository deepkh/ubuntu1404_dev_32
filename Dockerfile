...
RUN apt-get update
RUN apt-get install -y build-essential gperf bison flex texinfo help2man gawk libtool automake libncurses5-dev vim python python2.7-dev bc curl cmake git wget xz-utils apt-transport-https ca-certificates --no-install-recommends
