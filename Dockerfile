...
# sudo docker build -f Dockerfile -t deepkh/ubuntu1404_dev_32:base .
...
RUN apt-get update
RUN apt-get install -y build-essential debian-archive-keyring debootstrap qemu-user qemu-user-static gperf bison flex texinfo help2man gawk libtool automake libncurses5-dev vim python python2.7-dev bc curl cmake git wget xz-utils apt-transport-https ca-certificates --no-install-recommends
